...
const char* ssid = "ISIMA-Etudiants";
const char* password = "test1234";
WebServer server(80);

int Door = 15;  //PIN SERVO MOTEUR
bool etatDoor = 0;
bool etatPassword=0;
String msg;
...
long readUltrasonicDistance(int triggerPin, int echoPin)  // TrigerPin 23 , EchoPin 22
{
